...
- **🔎 Context Agent**: Actively investigates your codebase using "Vision" tools (`definitions`, `references`, `outlines`, `diagnostics`) and enforces **Surgical Selection** (line ranges) to eliminate token bloat and maximize precision.
